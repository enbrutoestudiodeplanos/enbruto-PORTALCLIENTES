...
breakdown.appendChild(document.createTextNode(`${result.cantidad} × ${formatARS(result.unitPrice)}`));
}
if (result.recargo > 0) {
if (breakdown.childNodes.length) breakdown.appendChild(document.createTextNode(' · '));
